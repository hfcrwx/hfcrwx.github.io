...
1
git clone --branch=v2.4.13 --depth=1 git@github.com:TarsCloud/TarsFramework.git --recursive
...
find . -regex '.*\.\(h\|hh\|hpp\|hxx\|c\|cc\|cpp\|cxx\)' -exec clang-format -style=file -i {} \;
...
git clone git@github.com:hfcrwx/TarsFramework-v2.4.13.git
cd build
./build.sh all
./build.sh i
./build.sh cleanall
